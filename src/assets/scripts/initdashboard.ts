export let teamSalesContacts = '<tr><td style="width: 100px;"><img src=".src/app/images/janet.png" /></td><td style=""><strong>Team lead:</strong> Petra Wilson<br /><strong>Phone: </strong>555-313-899<br /><strong>Email: </strong>petraw@company.com</td></tr>',
    ...
    teamSupportContacts = '<tr><td style="width: 100px;"><img src=".src/app/images/steven.png" /></td><td style=""><strong>Team lead:</strong> Michael Nagase<br /><strong>Phone: </strong>555-313-643<br /><strong>Email: </strong>nagase@company.com</td></tr>',
    ...
    const teamTableOptions =
        {
            ...
            source: dataAdapter,
            ready: function () {
                setTimeout(teamsDataTable.selectRow(0));
            },
            columns: [{
                text: 'Team',
                dataField: 'team',
