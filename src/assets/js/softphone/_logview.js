...
//--    }
    ...
    else if (logsendto === 2) // send in email
    {
        ...
        var email = webphone_api.common.GetConfig('supportmail');
        if (webphone_api.common.isNull(email) || email.length < 2) { email = webphone_api.common.GetConfig('log_email'); }
        
        if (!webphone_api.common.isNull(webphone_api.common.GetConfig('log_email')) && email.length > 2)
        {
