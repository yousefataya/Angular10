...
function onCreate (event)
{
    ...
    webphone_api.$("#btn_callhistorydetails_menu").attr("title", webphone_api.stringres.get("hint_menu"));
...
// handle hidesettings
    if (webphone_api.common.HideSettings('chat', webphone_api.stringres.get('sett_display_name_' + 'chat'), 'chat', true) === false || webphone_api.common.GetParameterInt('chatsms', 0) == 3)
    {
