...
var animateSlideIntern = function(nexttrans, comingtransition, container, nextli, actli, nextsh, actsh,  mtl) {
	...
	if (nexttrans==31||nexttrans==32||nexttrans==33||nexttrans==34) { // up , down, right ,left
		...
		//mtl.add(punchgs.TweenLite.set(nextsh.find('.defaultimg'),{autoAlpha:0}),0);border:1px solid #2c5894
		...
		function moveCircles(cont,ms,_nt,dir,ei) {
			...
			slot.wrap('<div class="slot-circle-wrapper" style="overflow:hidden;position:absolute;border:1px solid #2c5894"></div>');
	...
	if (nexttrans==11) {
			...
			if (specials>12) specials = 0;
				...
				var ssamount=0,
					bgcol = specials == 2 ? "#000000" : specials == 3 ? "#2c5894fff" : "transparent";					
