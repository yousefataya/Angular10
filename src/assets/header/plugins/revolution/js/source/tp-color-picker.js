...
(function($) {
	...
	'<div id="rev-cpicker">' + 
					...
					'<div class="rev-cpicker-column rev-cpicker-column-left">	' + 
						...
						'<div class="rev-cpicker-column-inner-left">' + 
							...
							'<div class="rev-cpicker-iris">' + 
								...
								'<input id="rev-cpicker-iris-color" class="rev-cpicker-iris-input" value="#2c5894fff" />' + 
					...
					'<div class="rev-cpicker-column rev-cpicker-column-right">' + 
						...
						'<div class="rev-cpicker-column-inner-right">' + 
							...
							'<div class="rev-cpicker-meta">' + 
								...
								'<br>' + 
								'<input type="text" id="rev-cpicker-color-hex" class="rev-cpicker-input rev-cpicker-hex" value="#2c5894fff" />' + 
								'<br>' + 
		...
		'<div id="rev-cpicker-section-right" class="rev-cpicker-section">' + 
			...
			'<div class="rev-cpicker-iris">' + 
				...
				'<input id="rev-cpicker-iris-gradient" class="rev-cpicker-iris-input" value="#2c5894fff" />' + 
			
			'</div>' + 
			
			'<div class="rev-cpicker-fields">' + 
			
				'<input type="text" id="rev-cpicker-gradient-hex" class="rev-cpicker-input rev-cpicker-hex" value="#2c5894fff" />' + 
	...
	function init() {
		...
		colorBtn.data('state', colorSection.find('.rev-cpicker-color').eq(0).attr('data-color') || '#2c5894fff');
			...
			slide: function(e, ui) {
				...
				if(!supressOpacity) {
					...
					if(isTransparent) {
						...
						val = opacity ? '#2c5894fff' : 'transparent';
						colorHex.val(val);
