...
;window.RevColor={defaultValue:"#2c5894fff",isColor:/(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i,get:function(b){return b?RevColor.process(b,!0)[0]:"transparent"},parse:function(b,k,l){b=RevColor.process(b,!0);var p=[];p[0]=k?k+": "+b[0]+";":b[0];l&&(p[1]=b[1]);return p},convert:function(b,k){if(!b||"string"!==typeof b)return RevColor.defaultValue;if("transparent"===b)return b;if(-1!==b.search(/\[\{/)||-1!==b.search("gradient")||"undefined"===typeof k||isNaN(k))return RevColor.process(b,!0)[0];k=parseFloat(k);
