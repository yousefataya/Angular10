...
export class AppComponent implements OnInit {
    ...
    // set page minified
    onToggleSidebarMinified(_val: boolean): void {
    ...
    onToggleSidebarRight(_val: boolean): void {
    ...
    // hide mobile sidebar
    onHideMobileSidebar(_val: boolean): void {
    ...
    onHideMobileRightSidebar(_val: boolean): void {
    ...
    onToggleMobileRightSidebar(_val: boolean): void {
        if (this.pageSettings.pageMobileRightSidebarToggled) {
            this.pageSettings.pageMobileRightSidebarToggled = false;
        } else {
    ...
    constructor( _titleService: Title,  slimLoadingBarService: SlimLoadingBarService,  router: Router, private renderer: Renderer2) {
