...
import { TrendsHomeComponent } from "src/app/views/main/trends/trends.component";
...
/*import { } from '@sy'*/
const routes: Routes = [
    { path: "home", component: TrendsHomeComponent }
];

@NgModule({
    declarations: [TrendsHomeComponent],
    bootstrap: [TrendsHomeComponent],
    imports: [
        HttpClientModule,
