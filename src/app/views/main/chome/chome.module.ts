...
import { AppCHomeComponent } from "./chome.component";
...
/*import { } from '@sy'*/
const routes: Routes = [
    { path: "home", component: AppCHomeComponent }
];

@NgModule({
    declarations: [AppCHomeComponent],
    bootstrap: [AppCHomeComponent],
    imports: [
        HttpClientModule,
