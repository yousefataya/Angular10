...
import { CalenderkHomeComponent } from "src/app/views/main/calender/calender.component";
...
/*import { } from '@sy'*/
const routes: Routes = [
    { path: "home", component: CalenderkHomeComponent }
];

@NgModule({
    declarations: [CalenderkHomeComponent],
    bootstrap: [CalenderkHomeComponent],
    imports: [
        HttpClientModule,
