...
@Component({ selector: "app-asterrisk", templateUrl: "./calender.component.html" })
export class CalenderkHomeComponent implements OnInit {
    ...
    sourceCalender: any =
        {
            ...
            id: 'id',
            url: 'http://192.168.225.81:8090/api/jqxCalenderSearchApi?peer=' + this.route.snapshot.queryParamMap.get('empName')
        };
