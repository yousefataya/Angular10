...
import { HomeComponentCommunicateInfo } from 'src/app/models/main.comunication.component.model';
...
export class AppComponentCommunicateService {
    ...
    Post(homeCallerInfo: HomeComponentCommunicateInfo): any {

        console.log('start ==> ' + homeCallerInfo)

        var objectModel = { componentName: homeCallerInfo.componentName, valueTxT: homeCallerInfo.valueTxT, txtNotes: homeCallerInfo.txtNotes }

        $(document).ready(function () {
           
            $.ajax({
                type: "POST",
                url: "http://192.168.1.103:3001/save-formnotes-processor",
