...
export class AppOldDbService {
    ...
    Post(oldDb: PersisitanceDbModel): any {

        console.log('start ==> ' + oldDb)

        $(document).ready(function () {

            $.ajax({
                type: "POST",
                url: "http://192.168.1.103:8090/api/ApiDbPersistance",
                data: JSON.stringify(oldDb),
