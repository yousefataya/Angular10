...
import { HomeCaseChildInfo } from "../models/main.situations.tabs.model";
...
export class AppChildernCaseService {
    ...
    Post(homeCallerInfo: HomeCaseChildInfo): any {

        console.log('start ==> ' + homeCallerInfo)

        var objectModel = { situationSelected: homeCallerInfo.situationSelected, livesWith: homeCallerInfo.livesWith , textDescription: homeCallerInfo.textDescription , description1: homeCallerInfo.description1, description2: homeCallerInfo.description2, description3: homeCallerInfo.description3   }

        $(document).ready(function () {
           
            $.ajax({
                type: "POST",
                url: "http://192.168.1.103:3001/save-case-processor",
