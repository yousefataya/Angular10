...
/*import { HomeReciveCallerInfo } from 'src/app/models/main.info.violance.model';*/
...
export class AppVoilanceService {
    ...
    Post(homeCallerInfo: HomeVoilanceCaseInfo): any {

        console.log('start ==> ' + homeCallerInfo)

        var objectModel = { volianceRelated: homeCallerInfo.volianceRelated, caseType: homeCallerInfo.caseType, socialSituation: homeCallerInfo.socialSituation, econmySituation: homeCallerInfo.econmySituation, voliancePlace: homeCallerInfo.voliancePlace, period: homeCallerInfo.period, description1: homeCallerInfo.description1, description2: homeCallerInfo.description2, description3: homeCallerInfo.description3 }

        $(document).ready(function () {

            $.ajax({
                type: "POST",
                url: "http://192.168.1.103:3001/save-voilance-processor",
