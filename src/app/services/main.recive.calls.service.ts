...
import { HomeReciveCallerInfo } from "../models/main.receive.calls.info.model";
...
export class AppRecCallerService {
    ...
    Post(homeCallerInfo: HomeReciveCallerInfo): any {

        console.log('start ==> ' + homeCallerInfo)

        var objectModel = { firstPerson: homeCallerInfo.firstPerson, secondPersonName: homeCallerInfo.secondPersonName, basedDate: homeCallerInfo.basedDate, startTime: homeCallerInfo.startTime, endTime: homeCallerInfo.endTime ,  description1: homeCallerInfo.description1, description2: homeCallerInfo.description2, description3: homeCallerInfo.description3 }

        $(document).ready(function () {

            $.ajax({
                type: "POST",
                url: "http://192.168.1.103:3001/rec-caller-processor",
